...
- [ ] Inspeccionar conectores activos y confirmar la cuenta/repositorio GitHub destino.
- [ ] Confirmar la cuenta/proyecto Vercel y la estrategia de hosting elegida.
- [ ] Preparar exportación del código y flujo de ramas sin secretos.
